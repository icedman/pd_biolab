...
#define entity_settings(ENTITY, DESC)                                          \
  entity_vtab[ENTITY->type].settings(ENTITY, DESC)
...
#define entity_kill(ENTITY)                                                    \
  (ENTITY->is_alive = false, entity_vtab[ENTITY->type].kill(ENTITY))
#define entity_touch(ENTITY, OTHER)                                            \
  entity_vtab[ENTITY->type].touch(ENTITY, OTHER)
...
#define entity_trigger(ENTITY, OTHER)                                          \
  entity_vtab[ENTITY->type].trigger(ENTITY, OTHER)
#define entity_message(ENTITY, MESSAGE, DATA)                                  \
  entity_vtab[ENTITY->type].message(ENTITY, MESSAGE, DATA)
